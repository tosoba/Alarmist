 ...
 *
 * @param titleContent the [Composable] title content of the list item; typically a 1-line prominent
 *   text within the list item; displayed below the top content (if present).
 ...
 *   title content may be the primary information, displaying the content such as images in the top
 *   allows to easy visual differentiation among the list items.
 ...
 *   checkbox, or a radio button displayed along side the bottom section with the headline and the
 *   supporting content.

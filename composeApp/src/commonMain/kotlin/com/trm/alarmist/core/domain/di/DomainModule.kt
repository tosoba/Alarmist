...
import com.trm.alarmist.core.domain.usecase.CalculateAlarmNextFireOnDateTimeUseCase
...
val domainModule = module {
  ...
  factory { ToggleAlarmOnOffUseCase(get(), get(), get()) }
  factory { CalculateAlarmNextFireOnDateTimeUseCase() }
  factory { UpdateAlarmScheduleUseCase(get(), get()) }

...
val LocalDate.epicMonth: EpicMonth
  get() = EpicMonth(year, month)
...
fun ClosedRange<EpicMonth>.getByIndex(index: Int) =
  start.addMonths(if (start < endInclusive) index else -index)

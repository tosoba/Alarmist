...
class MutableEpicCalendarPagerConfig(basisConfig: BasisEpicCalendarConfig) :
...
): MutableEpicCalendarPagerConfig =
  remember(basisConfig) { MutableEpicCalendarPagerConfig(basisConfig) }

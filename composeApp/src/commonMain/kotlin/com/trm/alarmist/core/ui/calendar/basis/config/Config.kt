package com.trm.alarmist.core.ui.calendar.basis.config
...
val LocalBasisEpicCalendarConfig =
  compositionLocalOf<BasisEpicCalendarConfig> { DefaultBasisEpicCalendarConfig }
